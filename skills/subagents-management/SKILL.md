...
```bash
python3 <skill-dir>/scripts/list_subagents.py [--scope user|project|all] [--json]
```
...
```bash
python3 <skill-dir>/scripts/create_subagent.py {name} \
  --description "..." \
  --prompt "..." \
  --scope {user|project} \
...
```bash
python3 <skill-dir>/scripts/move_subagent.py {name} --to {user|project} [--overwrite]
```
...
```bash
python3 <skill-dir>/scripts/delete_subagent.py {name} [--scope user|project] [--force]
```
