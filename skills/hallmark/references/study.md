...
| `figma.com/community/*`, `pinterest.com/pin/*` (design sharing / curation boards) | Soft-refuse. Same reasoning — curated design snippets, not extractable page structure. Offer DNA-only extraction. |
