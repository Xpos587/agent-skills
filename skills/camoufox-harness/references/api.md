...
| Function | Description | Example |
|----------|-------------|---------|
| `record_screen(func, video_dir, fps, max_frames, max_duration)` | Record screen to MP4 | `await record_screen(demo, fps=10, max_frames=300)` |
...
async def record_screen(func: Callable, video_dir: str = None, fps: int = 10, max_frames: int = 300, max_duration: int = 60) -> dict
